...
import com.communitask2.database;
...
public class LoginController implements Initializable {
    ...
    private boolean toDatabase() {
        ...
        String baranggay = Baranggay.getText().trim();
        ...
        String insertSQL = "INSERT INTO users (first_name, middle_name, surname, email, password, age, marital_status, birthday, baranggay) " + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection connection = database.getConnection();
         PreparedStatement preparedStatement = connection.prepareStatement(insertSQL)) {
            ...
            preparedStatement.setString(9, baranggay);
